...
# Looking at both the CPI and the Federal Rate from the year 1957 to 2016
...
trend_chart <- ggplot(cpi_fed_rate_ToT, group = 1) +
  ...
  labs(title = "Federeal Rate vs Annual CPI Mean by the years",
       subtitle = "Looking at the two rates from the years 1957 to 2016",
       x = "Years",
       y = "Annual Rate")
plot(trend_chart)
